<template>
    <Head>
        ...
        <meta type="description" content="Register Description" head-key="description">
    </Head>
    <main class="my-12">
        <section class="bg-white p-4 rounded-xl max-w-xl mx-auto border border-gray-300">
     <form @submit.prevent="submitRegister">
        <div class="mt-6">
         ...
         <h1 class="text-3xl mb-2 text-center w-full font-bold text-gray-700">Sign Up</h1>
         <h3 class="text-lg mb-6 text-center w-full font-bold text-gray-400">Create Your Monstrous Light Account</h3>
        ...
        <div class="mb-8 mx-10">
            ...
            >
            <div v-if="errors.confirm_password" v-text="errors.confirm_password" class="text-red-500 text-xs mt-1"></div>
        </div>
        <div class="mb-6 mx-10">
            <button type="submit"
